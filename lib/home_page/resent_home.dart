...
import 'package:firebase_pinput1/User_login/Sign_in.dart';
import 'package:firebase_pinput1/categories/categories.dart';
import 'package:firebase_pinput1/const/product_card.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                height: 150,
                color: Colors.black,
                child: Image.asset('assets/image/happy shopping.jpg',fit: BoxFit.cover),
              ),
              Padding(
